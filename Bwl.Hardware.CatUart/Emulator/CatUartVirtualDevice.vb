...
Public Class CatUartVirtualDevice
    ...
    Public Event ProcessPacketRequest(packet As Request, response As Response)
    ...
    Private Sub ProcessPacket(packet As Hardware.CatUart.Request)
